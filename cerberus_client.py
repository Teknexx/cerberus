...
if __name__ == '__main__':
    help()
    # knocking("127.0.0.1", 12345, [1111, 2222, 3333, 4444, 5555])
    knocking_with_pass("127.0.0.1", 12345, [1111, 2222, 3333, 4444, 5555], "p@ssw0rd!123!")

    # knocking("158.178.199.170", 22, [1111, 2222, 3333, 4444, 5555])
    # knocking_with_pass("158.178.199.170", 22, [1111, 2222, 3333, 4444, 5555], "p@ssw0rd!123!")
